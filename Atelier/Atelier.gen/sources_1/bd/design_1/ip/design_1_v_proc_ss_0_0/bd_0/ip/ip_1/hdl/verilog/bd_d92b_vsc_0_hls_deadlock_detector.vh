...
always @(negedge reset or posedge clock) begin
    ...
    bd_d92b_vsc_0_hls_deadlock_detect_unit #(5, 0, 3, 3) bd_d92b_vsc_0_hls_deadlock_detect_unit_0 (
        .reset(reset),
        .clock(clock),
    ...
    bd_d92b_vsc_0_hls_deadlock_detect_unit #(5, 1, 2, 2) bd_d92b_vsc_0_hls_deadlock_detect_unit_1 (
        .reset(reset),
        .clock(clock),
    ...
    bd_d92b_vsc_0_hls_deadlock_detect_unit #(5, 2, 4, 4) bd_d92b_vsc_0_hls_deadlock_detect_unit_2 (
        .reset(reset),
        .clock(clock),
    ...
    bd_d92b_vsc_0_hls_deadlock_detect_unit #(5, 3, 3, 3) bd_d92b_vsc_0_hls_deadlock_detect_unit_3 (
        .reset(reset),
        .clock(clock),
    ...
    bd_d92b_vsc_0_hls_deadlock_detect_unit #(5, 4, 2, 2) bd_d92b_vsc_0_hls_deadlock_detect_unit_4 (
        .reset(reset),
        .clock(clock),
...
`include "bd_d92b_vsc_0_hls_deadlock_report_unit.vh"
