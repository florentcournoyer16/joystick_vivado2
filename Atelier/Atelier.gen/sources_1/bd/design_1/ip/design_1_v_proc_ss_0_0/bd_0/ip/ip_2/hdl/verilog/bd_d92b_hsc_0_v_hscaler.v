...
(* CORE_GENERATION_INFO="bd_d92b_hsc_0_v_hscaler,hls_ip_2020_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z010-clg400-1,HLS_INPUT_CLOCK=13.468000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=9.815250,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=7,HLS_SYN_DSP=0,HLS_SYN_FF=4491,HLS_SYN_LUT=5609,HLS_VERSION=2020_2}" *)

module bd_d92b_hsc_0_v_hscaler (
        s_axi_CTRL_AWVALID,
        s_axi_CTRL_AWREADY,
        s_axi_CTRL_AWADDR,
        s_axi_CTRL_WVALID,
...
bd_d92b_hsc_0_v_hscaler_entry4 v_hscaler_entry4_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
bd_d92b_hsc_0_v_hscaler_entry32 v_hscaler_entry32_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
bd_d92b_hsc_0_Block_split1_proc Block_split1_proc_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
bd_d92b_hsc_0_Block_split12_proc Block_split12_proc_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
bd_d92b_hsc_0_AXIvideo2MultiPixStream AXIvideo2MultiPixStream_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
bd_d92b_hsc_0_v_hcresampler_core26 v_hcresampler_core26_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
bd_d92b_hsc_0_hscale_core_polyphase hscale_core_polyphase_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
bd_d92b_hsc_0_v_hcresampler_core v_hcresampler_core_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
bd_d92b_hsc_0_v_vcresampler_core v_vcresampler_core_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
bd_d92b_hsc_0_MultiPixStream2AXIvideo MultiPixStream2AXIvideo_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst_n_inv),
...
bd_d92b_hsc_0_fifo_w8_d2_S ColorMode_c1_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_d92b_hsc_0_fifo_w8_d2_S ColorMode_c_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_d92b_hsc_0_fifo_w8_d2_S ColorMode_c17_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_d92b_hsc_0_fifo_w1_d2_S bPassThruHcr1_channel_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_d92b_hsc_0_fifo_w1_d6_S bPassThruHcr2_c_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_d92b_hsc_0_fifo_w1_d7_S bPassThruVcr_c_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_d92b_hsc_0_fifo_w24_d16_S stream_in_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_d92b_hsc_0_fifo_w24_d16_S stream_upsampled_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_d92b_hsc_0_fifo_w24_d16_S stream_scaled_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_d92b_hsc_0_fifo_w24_d16_S stream_out_422_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_d92b_hsc_0_fifo_w24_d16_S stream_out_420_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_d92b_hsc_0_start_for_v_hscaler_entry32_U0 start_for_v_hscaler_entry32_U0_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_d92b_hsc_0_start_for_Block_split1_proc_U0 start_for_Block_split1_proc_U0_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_d92b_hsc_0_start_for_AXIvideo2MultiPixStream_U0 start_for_AXIvideo2MultiPixStream_U0_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_d92b_hsc_0_start_for_v_hcresampler_core_U0 start_for_v_hcresampler_core_U0_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_d92b_hsc_0_start_for_v_vcresampler_core_U0 start_for_v_vcresampler_core_U0_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
bd_d92b_hsc_0_start_for_MultiPixStream2AXIvideo_U0 start_for_MultiPixStream2AXIvideo_U0_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
`include "bd_d92b_hsc_0_hls_deadlock_detector.vh"
// synthesis translate_on

endmodule //bd_d92b_hsc_0_v_hscaler
