...
module bd_d92b_hsc_0_hscale_core_polyphase (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
bd_d92b_hsc_0_hscale_core_polyphase_FiltCoeff_0_0 #(
    .DataWidth( 16 ),
    .AddressRange( 64 ),
    .AddressWidth( 6 ))
FiltCoeff_0_0_U(
...
bd_d92b_hsc_0_hscale_polyphase grp_hscale_polyphase_fu_519(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
bd_d92b_hsc_0_reg_ap_uint_9_s grp_reg_ap_uint_9_s_fu_759(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
endmodule //bd_d92b_hsc_0_hscale_core_polyphase
